	 ...
	 */
     public void doPost(HttpServletRequest req, HttpServletResponse rsp)   
      ...
      //For log
       ...
       //Create new thread??
		/*
		 * out.
		 * println("<br><p><input type=\"button\" value=\"Back to request form\" onClick=\"window.location.reload()\"></p>"
		 * );
		 * 
		 * out.println("<fieldset>");
		 * out.println("<p><b>Your request has been received. Many thanks " + name
		 * +" for using LogMap's Web facility.</b></p>"); out.println("<ul>");
		 * //out.println("<li><b>Ontology 1:</b> " + uri1 + "</li>");
		 * //out.println("<li><b>Ontology 2:</b> " + uri2 + "</li>");
		 * out.println("<li><b>Ontology 1:</b> " + "<a href=\""+uri1
		 * +"\" target=\"_blank\">" + uri1 + "</a></li>");
		 * out.println("<li><b>Ontology 2:</b> " + "<a href=\""+uri2
		 * +"\" target=\"_blank\">" + uri2 + "</a></li>");
		 * out.println("<li><b>Version:</b> " + logmap_version + "</li>");
		 * out.println("</ul>");
		 * 
		 * //Commented to avoid people putting fake emails //out.
		 * println("<p><b>The progress of the matching process can be followed from:</b> "
		 * + //
		 * "<a href=\""+output_file_manager.getHTMLResultsURI()+"\" target=\"_blank\">"
		 * + output_file_manager.getHTMLResultsURI() + //
		 * "</a>   <FONT COLOR=\"red\"><i>(please, record this link)</i></FONT></p>");
		 * 
		 * //out.println("<p><b>We have also sent you an email to</b> '" + email +
		 * "' <b>with this information.</b></p>");
		 * 
		 * out.println("<p><b>We have sent you an e-mail to</b> '" + email +
		 * "' <b>with a 'link' to the progress and results of the matching task.</b></p>"
		 * );
		 * 
		 * 
		 * out.println("</fieldset>");
		 * 
		 * out.
		 * println("<p><input type=\"button\" value=\"Back to request form\" onClick=\"window.location.reload()\"></p>"
		 * );
		 */
       ...
       out.println("<div class=\"col\">"
    		   +      "<div class=\"card mb-4 rounded-3 shadow-sm\">"
       		   +		"<div class=\"card-body\">"
    		   +			"<h4 class=\"my-0 fw-normal text-center mb-5\">Your request has been received.</br>"
       		   +				"Many thanks " + name + " for using LogMap's Web facility."
       		   +			"</h4>"
       		   +			"<div class=\"row table-responsive\">" 
       		   +			"<table class=\"table w70 table-center mb-5\">"
       		   +			  "<tbody>"
       		   +				"<tr>"
       		   +					"<th scope=\"row\">Ontology 1</th>"
       		   +					"<td><a href=\"" + uri1 + "\" target=\"_blank\">\""+ uri1 + "\"</a></td>"
       		   +				"</tr>"
       		   +				"<tr>"
       		   +					"<th scope=\"row\">Ontology 2</th>"
     		   +					"<td><a href=\"" + uri2 + "\" target=\"_blank\">\""+ uri2 + "\"</a></td>"
     		   +				"</tr>"
       		   +				"<tr>"
       		   +					"<th scope=\"row\">Version</th>"
       		   +					"<td>"+ logmap_version +"</td>"
       		   +				"</tr>"
       		   +			  "</tbody>"
       		   +			"</table>"
       		   +			"</div>"
       		   +			"<ul class=\"list-unstyled mt-3 mb-4 text-center\">"
       		   +				"<li>We have sent you an e-mail to '" + email + "'</li>"
       		   +				"<li>with a 'link' to the progress and results of the matching task. </li>"
       		   +			"</ul>"
       		   +			"<button type=\"button\" class=\"w-100 btn btn-lg btn-primary\" onClick=\"window.location.reload()\">Back to request form</button>"
       		   +		"</div>"
       		   +	"</div>"
       		   +  "</div>");
       ...
       System.out.println("output_uri======"+ output_uri);
     ...
     class LogMapThread implements Runnable {
    	 ...
    	 LogMapThread(
        	 ...
        	 T_output_path=output_path.replace("\\", "/"); //window path change 
         ...
         public void run() {
        	 ...
        	 try{
	        	 ...
	        	 if (T_logmap_version.equals("LogMap with reasoning")){
	        		 System.out.println("LogMap with reasoning!!!!!");
	        		 ...
	        		 System.out.println("LogMap with interactivity!!!!!");
	        		 int reasoner;
	        		 if (T_useReasoner) {
